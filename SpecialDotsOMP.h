...
void specialDotsOMP(RGBTRIPLE**& rgb_in, RGBTRIPLE**& rgb_out, int imHeight, int imWidth, int threads, int ksize = 5)
{
...
void specialDotsOMPVector(RGBTRIPLE**& rgb_in, RGBTRIPLE**& rgb_out, int imHeight, int imWidth, int threads, int ksize = 5)
{
