...
void specialDotsOMPTBB(RGBTRIPLE**& rgb_in, RGBTRIPLE**& rgb_out, int imHeight, int imWidth, int threads, int ksize = 5)
{
...
#pragma omp parallel for
	...
	t8.push_back(omp_get_wtime() - start);
...
void specialDotsOMPTBBVector(RGBTRIPLE**& rgb_in, RGBTRIPLE**& rgb_out, int imHeight, int imWidth, int threads, int ksize = 5)
{
