void special_dots(RGBTRIPLE**& rgb, RGBTRIPLE**& rgb_out, int height, int width, int ksize = 5)
{
...
void special_dots_concurrent_vector(RGBTRIPLE**& rgb, RGBTRIPLE**& rgb_out, int height, int width, int ksize = 5)
{
