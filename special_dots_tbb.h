void special_dots_tbb(RGBTRIPLE**& rgb, RGBTRIPLE**& rgb_out, int height, int width, int ksize = 5)
{
...
void special_dots_tbb_concurrent_vector(RGBTRIPLE**& rgb, RGBTRIPLE**& rgb_out, int height, int width, int ksize = 5)
{
